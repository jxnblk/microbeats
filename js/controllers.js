...
microbeats.controller('MainCtrl', ['$scope', '$http', 'player', 'audio', '$location', function($scope, $http, player, audio, $location) {
...
microbeats.controller('ScrubberCtrl', ['$scope', 'audio', function($scope, audio) {
