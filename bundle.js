...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tracks = __webpack_require__(5);
	    ...
	    return (
	      React.createElement("html", null, 
	        ...
	        React.createElement("body", {className: ""}, 
	          ...
	          React.createElement(Tracks, React.__spread({},  this.props, 
	            this.state, 
	            {playPause: this.playPause})), 
	          React.createElement("script", {id: "initial-props", type: "application/json", dangerouslySetInnerHTML: initialProps}), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hhmmss = __webpack_require__(30);
	  ...
	  render: function() {
	    return (
	      React.createElement("div", null, 
	        React.createElement("button", {className: "button button-transparent", 
	          onClick: this.playPause}, 
	          React.createElement(Icon, {name: this.props.playing ? 'pause' : 'play'})
	        ), 
	        React.createElement(Icon, {name: "previous"}), 
	        React.createElement(Icon, {name: "next"}), 
	        React.createElement("samp", null, hhmmss(this.props.currentTime))
	      )
	    )
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Track = __webpack_require__(7);

	var Tracks = React.createClass({displayName: "Tracks",

	  renderTrack: function(track, i) {
	    return (
	      React.createElement("li", {key: 'track-'+i}, 
	        React.createElement(Track, React.__spread({},  this.props, {track: track}))
	      )
	    )
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var audio = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Track = React.createClass({displayName: "Track",
	  ...
	  render: function() {
	    ...
	    return (
	      React.createElement("button", {className: "col-12 block left-align button button-transparent"}, 
	        React.createElement("div", {className: "flex"}, 
	          React.createElement("div", {className: "flex-auto"}, 
	            this.props.track.title
	          ), 
	          React.createElement("div", {className: "h6 regular"}, 
	            hhmmss(this.props.track.duration)
	          ), 
	          React.createElement("div", {className: "h6 regular"}, 
	            date
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {// Audio element
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var paths = __webpack_require__(142);
